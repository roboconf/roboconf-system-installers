...
do_start_karaf_dm()
{
	...
	start-stop-daemon --start --chuid roboconf-dm --quiet --background --make-pidfile --pidfile $PIDFILE --startas $DAEMON --test -- daemon > /dev/null \
		|| return 1
	start-stop-daemon --start --chuid roboconf-dm --quiet --background --make-pidfile --pidfile $PIDFILE --startas $DAEMON -- daemon \
		|| return 2
}
